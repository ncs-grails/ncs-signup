  ...
  <body class="center">
    ...
    <div class="grid_12" id="unit_footer2">
	  <ul class="unit_footer_links">
		<li>Address: 200 Oak <acronym class="acronym_border" title="Street Southeast">St SE</acronym>, Minneapolis, MN 55455 Phone: 1-866-315-7126</li>
		<li><a href="mailto:${'info@ncs.umn.edu'}">Contact Ramsey County Study Center</a></li>
	  </ul>
    </div>
